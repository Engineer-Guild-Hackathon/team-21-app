...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "NOT_STARTED", "IN_PROGRESS", "COMPLETED", "LOCKED", name="queststatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_quest_progresses_id"), "quest_progresses", ["id"], unique=False
    )
    op.create_table(
        "quest_rewards",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_quest_sessions_id"), "quest_sessions", ["id"], unique=False
    )
