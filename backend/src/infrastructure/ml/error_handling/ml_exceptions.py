...
class InvalidInputError(MLBaseException):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=message, error_code="INVALID_INPUT", details=details)
...
class PredictionError(MLBaseException):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, error_code="PREDICTION_ERROR", details=details
        )
...
class DataQualityError(MLBaseException):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, error_code="DATA_QUALITY_ERROR", details=details
        )
