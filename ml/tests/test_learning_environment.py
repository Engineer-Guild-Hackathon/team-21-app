...
def test_step_execution(env):
    """ステップ実行のテスト"""
    action = {"task_type": 0, "difficulty": 1, "feedback_style": 0}
...
def test_reward_calculation(env):
    """報酬計算のテスト"""
    action = {"task_type": 0, "difficulty": 4, "feedback_style": 0}  # 高難度
...
def test_difficulty_impact(env):
    ...
    # 低難度アクション
    easy_action = {"task_type": 0, "difficulty": 1, "feedback_style": 0}

    # 高難度アクション
    hard_action = {"task_type": 0, "difficulty": 4, "feedback_style": 0}
...
def test_emotional_state_changes(env):
    ...
    action = {"task_type": 0, "difficulty": 2, "feedback_style": 0}
