...
from .emotion_analyzer import EmotionCategory, EmotionAnalysisResult
...
class FeedbackGenerator:
    ...
    def _determine_feedback_style(self, context: FeedbackContext) -> FeedbackStyle:
        ...
        elif emotion == EmotionCategory.MOTIVATED or emotion == EmotionCategory.CONFIDENT:
    ...
    def _extract_context_info(self, context: FeedbackContext) -> Dict[str, str]:
        ...
        return {
            'achievement': recent_achievements[0] if recent_achievements else "これまでの努力",
            ...
            'past_success': recent_achievements[-1] if recent_achievements else "これまでの成功体験",
    ...
    def _extract_recent_achievements(self, task_history: List[Dict[str, any]]) -> List[str]:
        """最近の成果の抽出"""
        achievements = []
