...
class DQNAgent:
    ...
    def get_action_for_emotional_state(
        self, emotional_state: Dict[str, float], learning_progress: Dict[str, float]
    ) -> Dict:
        """
        ...
        # 行動の種類（例）
        actions = [
            {"type": "easy_quest", "description": "気分転換のための簡単なクエスト提供"},
            {"type": "hint", "description": "ヒントを提供するNPCとの会話"},
            {"type": "challenge", "description": "難易度の高い問題の提供"},
            {"type": "skill_quest", "description": "新しいスキル習得のためのクエスト"},
            {"type": "break", "description": "小休憩の提案"},
        ]
