  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24">
      <div className="w-full max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 gradient-text">感情コントロール入門</h1>

        {/* ステップ1: 感情認識 */}
        <div className="card p-8 mb-8">
          <h2 className="text-2xl font-semibold mb-4">ステップ1: 今の感情を認識する</h2>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">現在の感情</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">きっかけ</label>
              <textarea
                value={trigger}
        ...
        {emotionLogs.length > 0 && (
          <div className="card p-8 mb-8">
            <h2 className="text-2xl font-semibold mb-4">ステップ2: 感情の振り返り</h2>
            <div className="space-y-4">
        ...
        {emotionLogs.length >= 3 && (
          <div className="card p-8">
            <h2 className="text-2xl font-semibold mb-4">ステップ3: 感情コントロールの方法</h2>
            <div className="space-y-4">
